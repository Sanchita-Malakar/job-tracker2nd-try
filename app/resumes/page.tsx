...
// ============================================================
//  FIXES APPLIED:
//  1. useData() now works because DataProvider is in layout.tsx
//  2. Files show uploaded_at date
//  3. Notes show which application they belong to
//  4. Proper empty states for files and notes sections
//  5. Search filters across company, role, file name, note content
// ============================================================
                    ...
                    {filteredFiles.map(file => (
                      <div
                        ...
                        onMouseEnter={e => {
                          ...
                          (e.currentTarget as HTMLDivElement).style.background = "rgba(79,142,247,0.05)";
                        }}
                        onMouseLeave={e => {
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontSize: 14, fontWeight: 700, color: "#e8eaf2", marginBottom: 4, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                            {file.name}
                          </div>
                          <div style={{ display: "flex", gap: 12, fontSize: 12, color: "#a1a8c6", flexWrap: "wrap" }}>
                            <span style={{ display: "flex", alignItems: "center", gap: 4 }}>
                              <span style={{ width: 6, height: 6, borderRadius: "50%", background: STATUS_COLORS[file.status] ?? "#a1a8c6", display: "inline-block" }} />
                              {file.company} — {file.role}
                            </span>
                            <span>·</span>
                            {/* FIX 2: Show upload date */}
                      ...
                      >
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <span style={{ width: 8, height: 8, borderRadius: "50%", background: STATUS_COLORS[note.status] ?? "#a1a8c6", boxShadow: `0 0 8px ${STATUS_COLORS[note.status] ?? "#a1a8c6"}`, display: "inline-block" }} />
